...
def ABCpmc_HOD(T, eps_val, N_part=1000, prior_name='first_try', observables=['nbar', 'xi'], 
    ...
    for pool in abcpmc_sampler.sample(prior, eps):
        ...
        if (pool.t < 4) and (pool.t>2):
            pool.thetas = np.loadtxt("/home/mj/abc/halo/dat/gold/nbar_xi_Mr21_theta_t3.mercer.dat")
            pool.ws = np.loadtxt("/home/mj/abc/halo/dat/gold/nbar_xi_Mr21_w_t3.mercer.dat")
