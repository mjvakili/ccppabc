...
{\bf \color{darkgreen}
CHH: @MJV, I parrot a lot of arguments made in the intro without providing much extra 
'meat'. Let me know what you think. 
}
...
make correctly predicting the functional form of the likelihood intractable.
In the standard Gaussian pseudo-likelihood analysis, and other analysis that
require writing down a likelihood function, these effects can significantly 
...
{\bf \color{darkgreen}
Need discussion of applying ABC to real data. 
\begin{itemize}
\item Computational tractability caveats. The forward models in real data scenarios would have to be much bigger. 
\item They would also have to be better than the ones that are currently used for covariance matrix estimation. 
\item Complexity of systematic effects (mention DESI) 
